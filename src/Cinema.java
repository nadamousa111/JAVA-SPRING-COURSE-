...
public static boolean bookSeat(int seatNumber,char[][]seats){
    Scanner sc = new Scanner(System.in);
     ...
     while(true) {
         ...
         if (row <= 0 || row > seats.length || col <= 0 || col > seats[0].length) {
             ...
             System.out.println("This seat is already booked ! , enter another seat");
    ...
    public static boolean cancelBooking(int seatNumber,char[][]seats){
        Scanner sc = new Scanner(System.in);
        int row = seatNumber / 10 ;
        int col = seatNumber %10;
        while(true) {
            ...
            if (row <= 0 || row > seats.length || col <= 0 || col > seats[0].length) {
                ...
                System.out.println("This seat is not booked ! , enter another seat");
      ...
      while(true){
          ...
          switch (option){
              ...
              case 3:
                  ...
                  seatNumber = input.nextInt();
                  if(cancelBooking(seatNumber,seats)) {
                      availableSeatsCount++;
                      bookedSeatsCount--;
                  }
              ...
              case 5:
                  ...
                  if(bookedSeatsCount >= 0.8*(rows*columns)){
